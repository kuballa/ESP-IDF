...
#define REMOTE_SERVICE_UUID        0x00EE
#define REMOTE_NOTIFY_CHAR_UUID    0xEE01
...
//        }
        write_char_data[0] = 22;
        write_char_data[1] = 44;
        write_char_data[2] = 66;
        write_char_data[3] = 88;
