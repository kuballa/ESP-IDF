...
//#define REMOTE_NOTIFY_CHAR_UUID 0x2A36
//#define REMOTE_SERVICE_UUID 0x0180
//#define REMOTE_NOTIFY_CHAR_UUID 0xFEF0
//#define REMOTE_SERVICE_UUID 0x0180
//#define REMOTE_NOTIFY_CHAR_UUID 0xFEF4
//#define REMOTE_SERVICE_UUID 0x180A
//#define REMOTE_NOTIFY_CHAR_UUID 0x2A24
...
//static const char remote_device_name[] = "BLE-Server";
//static const char remote_device_name[] = "IoT-BLE";
...
//         int battery_percentage = (int)*char_pointer;
         battery_percentage = (float)char_pointer[0] * 100 + (float)char_pointer[1];
         battery_percentage2 = (float)char_pointer[2] * 100 + (float)char_pointer[3];
         battery_percentage3 = (float)char_pointer[4] * 100 + (float)char_pointer[5];

//         ESP_LOGI(GATTC_TAG, "(p_data->read.value) Message: %s ", char_pointer);
         ESP_LOGI(GATTC_TAG, "(p_data->read.value) gas: %.02f ", battery_percentage/100);
         ESP_LOGI(GATTC_TAG, "(p_data->read.value) temperature: %.02f ", battery_percentage2/100);
         ESP_LOGI(GATTC_TAG, "(p_data->read.value) pressure: %.02f ", battery_percentage3/100);
